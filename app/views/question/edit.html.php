...
<form action="<?= URLROOT ?>/question/edit/<?=$data['id']?>" method="post" enctype="multipart/form-data">
  ...
  <?php endforeach; ?>
    ...
    <div class="mb-4">
      <label class="block text-gray-700 text-sm font-bold mb-2" for="image_path">Image(optional)
      </label>
